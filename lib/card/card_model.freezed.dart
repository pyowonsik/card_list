...
abstract class $CardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String card, bool isChecked, DateTime time});
}
...
class _$_CardModel implements _CardModel {
  _$_CardModel(
      {required this.card, required this.isChecked, required this.time});
  ...
  @override
  String toString() {
    return 'CardModel(card: $card, isChecked: $isChecked, time: $time)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, card, isChecked, time);
...
abstract class _CardModel implements CardModel {
  factory _CardModel(
      ...
      required final DateTime time}) = _$_CardModel;
